...
public class ExpireCondition {
    ...
    public ExpireCondition(boolean requiresExistingExpiry, boolean requiresNoExpiry, boolean requiresLessThan, boolean requiresGreaterThan) {
    ...
    public static ExpireCondition fromExpireArgs(ExpireArgs expireArgs) {
        ...
        return new ExpireCondition(requiresExistingExpiry, requiresNoExpiry, requiresLessThan, requiresGreaterThan);
    }
}
